				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="libs/images/logo.png" alt="logo-dkm" width="220" />
						</td>
						<td class="text-center" width="200%">
						<b>PT. United Tractors Tbk</b> <br>
						Kawasan Petambangan, Sorowako, Kabupaten Luwu-Timur, Sorowako 92983<br>
						Telp: (021) 1234567<br>
						<td class="text-right" width="20%">
							<img src="libs/images/moving as one.png" alt="logo-dkm" width="170" height=""/>
						</td>
					</tr>
				</tbody>
			</table>
