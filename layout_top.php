...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti Online PT. UNITED TRACTORS - <?php echo $pagedesc ?></title>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="libs/images/logo.png" alt="" width="220" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong></strong></div>
					<div class="clear-both"></div>
				</a>
				<a class="navbar-brand visible-xs" href="index.php">
					<img src="libs/images/header.png" alt="" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>PT. UNITED TRACTORS </strong></div>
					<div class="clear-both"></div>
				</a>
			</div><!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Cuti Online <br> <b>PT. UNITED TRACTORS </b></h4>
