				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="libs/images/logo.png" alt="" width="70" />
						</td>
						<td class="text-center" width="60%">
						<b>PT. United Tractors</b> <br>
						Jl. Krakatau VI No.2, Kawasan Petambangan, Sorowako, Kabupaten Luwu-Timur, Sorowako 92983<br>
						Telp: (021) 12345678<br>
						<td class="text-right" width="20%">
							<img src="libs/images/moving as one.png" alt="" width="70" height=""/>
						</td>
					</tr>
				</tbody>
			</table>
