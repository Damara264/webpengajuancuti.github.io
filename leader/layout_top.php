...
<head>
	...
	<title>Pengajuan Cuti Online PT. UNITED TRACTORS - <?php echo $pagedesc ?></title>
	<img src="../libs/images/logo.png" alt="brand" width="20" class="float-left image-brand">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="../libs/images/logo.png" alt="brand" width="220" class="float-left image-brand">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Pengajuan Cuti Online <br> <b>PT. UNITED TRACTORS TBK</b></h4>
