				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="libs/images/header.png" alt="" width="70" />
						</td>
						<td class="text-center" width="60%">
						<b>PT. United Tractors Tbk.</b> <br>
						Jl. Merapi F.108 Sorowako Kabupaten Luwu-Timur Sulawesi-Selatan<br>
						Telp: (021) 89115030<br>
						<td class="text-right" width="20%">
							<img src="libs/images/header.png" alt="" width="70" height=""/>
						</td>
					</tr>
				</tbody>
			</table>
